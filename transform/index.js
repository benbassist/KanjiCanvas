...
// parse the file and create a new JSON file
    function diveFileHandler(err, file) {
        ...
        if (joyo.indexOf(filename.toUpperCase()) !== -1) {
            joyo.splice(joyo.indexOf(filename.toUpperCase()), 1);
            numTransformed++;
